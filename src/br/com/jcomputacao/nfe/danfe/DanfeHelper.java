...
public class DanfeHelper {
    public JasperPrint imprimir(TNfeProc proc, Image logotipo) throws JRException, IOException {
        List<TNfeProc> l = new ArrayList<TNfeProc>();
        l.add(proc);
        return imprimir(l, logotipo);
    }

    public JasperPrint imprimir(List<TNfeProc> procs, Image logotipo) throws JRException, IOException {
        InputStream is = null;
