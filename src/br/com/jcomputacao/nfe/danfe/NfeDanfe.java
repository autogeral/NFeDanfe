...
import br.inf.portalfiscal.nfe.xml.pl006q.nfes.TNFe.InfNFe.Dest;
...
import br.inf.portalfiscal.nfe.xml.pl006q.nfes.TNFe.InfNFe.Total;
import br.inf.portalfiscal.nfe.xml.pl006q.nfes.TNFe.InfNFe.Total.ISSQNtot;
import br.inf.portalfiscal.nfe.xml.pl006q.nfes.TNFe.InfNFe.Transp;
...
//        proc.getProtocolo().getInformacoes().getDataHoraRecebimento();
        ...
        if(transporte.getVol() != null && !transporte.getVol().isEmpty()){
            List<Vol> volumes = transporte.getVol();
            for(Vol volume:volumes){
        ...
        if (tot != null) {
            ISSQNtot issqn = tot.getISSQNtot();
            if (issqn != null) {
