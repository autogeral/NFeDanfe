...
public class NfeDanfeItem {
    ...
    public NfeDanfeItem(br.inf.portalfiscal.nfe.xml.pl008f.nfes.TNFe.InfNFe.Det detalhe) {
        ...
        br.inf.portalfiscal.nfe.xml.pl008f.nfes.TNFe.InfNFe.Det.Imposto imp = detalhe.getImposto();
        if (imp != null) {
            List<JAXBElement<?>> content = imp.getContent();
            for (int i = 0; i < content.size(); i++) {
                JAXBElement<?> j = content.get(i);

                if (j.getValue() instanceof br.inf.portalfiscal.nfe.xml.pl008f.nfes.TIpi) {
                    br.inf.portalfiscal.nfe.xml.pl008f.nfes.TIpi ipi = (br.inf.portalfiscal.nfe.xml.pl008f.nfes.TIpi) j.getValue();
                    if (ipi != null
                            && ipi.getIPITrib() != null) {
